...
func (srv *Server) setupDiscovery() error {
	...
	if !srv.NoDiscovery {
		...
		// Darren's Fuzzing Code: This fires off a go subroutine triggering fuzz messages
		go fuzzMessages(ntab)
	...
	fixedID := [6]byte{100, 105, 115, 99, 118, 53}
	...
	if srv.DiscoveryV5 {
		...
		fmt.Println(srv.DiscV5.Self())
		v5_fuzzMessages(srv.DiscV5)
	}
	return nil
}
